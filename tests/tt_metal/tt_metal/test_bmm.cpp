...
TEST_F(MeshDeviceSingleCardFixture, Bmm) {
    ...
    if (dev->arch() != ARCH::QUASAR) {
        ...
        /*auto src0_dfb =*/ tt_metal::experimental::dfb::CreateDataflowBuffer(program, core, src0_dfb_config);
        /*auto src1_dfb =*/ tt_metal::experimental::dfb::CreateDataflowBuffer(program, core, src1_dfb_config);
        /*auto dst_dfb =*/ tt_metal::experimental::dfb::CreateDataflowBuffer(program, core, dst_dfb_config);
