 ...
 * Custom piecewise trainable activation for transformer MLP blocks.
 * | idst | alpha_p (alpha positive) | alpha_n (alpha negative) |
 */
...
ALWI void xielu_tile_init() { MATH(SFPU_UNARY_KERNEL_INIT(xielu, APPROX)); }
